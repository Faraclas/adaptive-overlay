...
inherit pypi cargo distutils-r1
...
LICENSE+=" Apache-2.0-with-LLVM-exceptions BSD Unicode-DFS-2016"
SLOT="0"
KEYWORDS="~amd64"

QA_FLAGS_IGNORED="usr/lib.*/py.*/site-packages/anydoc/.*.so"
