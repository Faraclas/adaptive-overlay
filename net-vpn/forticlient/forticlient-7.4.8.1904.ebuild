...
SRC_URI="https://repo.fortinet.com/repo/forticlient/$(ver_cut 1-2)/ubuntu/pool/non-free/f/${PN}/${PN}_${PV}_amd64.deb"
...
src_install() {
	...
	fperms 0644 /opt/forticlient/.config.db.init
	...
	fperms +x /opt/forticlient/tpm2/lib/pkcs11.so
	...
	dosym ../forticlient/vpn opt/bin/fortivpn
