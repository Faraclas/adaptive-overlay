...
src_prepare() {
	...
	local WGPU_COMMIT="465557eccfe77c840a9b4936f1408da9503372c4"
	local WGPU_GIT="wgpu = { git = \"https://github.com/zed-industries/wgpu\", rev = \"${WGPU_COMMIT}\""
